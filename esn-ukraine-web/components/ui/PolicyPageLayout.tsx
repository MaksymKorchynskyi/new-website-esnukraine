...
export default function PolicyPageLayout({
  ...
  return (
    <main className="min-h-svh bg-white text-esn-dark selection:bg-esn-cyan selection:text-white">
      {/* ======================== Hero Section ======================== */}
      <section className="relative bg-gradient-to-b from-gray-50 to-white pt-28 sm:pt-32 md:pt-36 pb-10 sm:pb-14 overflow-hidden">
        {/* Decorative blurs */}
        ...
        <div className="mx-auto max-w-5xl px-5 sm:px-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-1.5 text-sm text-gray-400">
              ...
              <li>
                <span className="text-esn-dark font-semibold">{title}</span>
              </li>
            </ol>
          </nav>

          {/* Title */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-esn-dark mb-4">
            {title}
          </h1>
      ...
      {/* ======================== Content Section ======================== */}
      <section className="mx-auto max-w-5xl px-5 sm:px-12 pb-16 sm:pb-24">
        {/* Mobile ToC */}
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            <div className="prose prose-lg max-w-none prose-headings:font-black prose-headings:text-esn-dark prose-headings:tracking-tight prose-a:text-esn-cyan prose-a:no-underline hover:prose-a:underline prose-strong:text-esn-dark prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-table:text-sm prose-th:text-esn-dark prose-th:font-bold prose-th:bg-gray-50 prose-td:text-gray-600">
              {children}
            </div>
          </div>

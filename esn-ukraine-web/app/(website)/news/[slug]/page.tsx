          ...
          {value.images.map((img: any, idx: number) => {
            ...
            return (
              <figure key={img._key || idx} className={`group relative overflow-hidden aspect-[4/3] ${isRounded ? "rounded-xl" : ""}`}>
                ...
                />
                {img.caption && (
                  <figcaption className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-black/0 p-3 pt-8 opacity-100">
          ...
          {images.map((img, idx) => {
            ...
            return (
              ...
              >
                ...
                {img.caption && (
                  <figcaption className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-black/0 p-4 pt-10 opacity-100">
    ...
    <main className="min-h-svh bg-white">
      ...
      <section className="py-16 md:py-20 px-6 sm:px-12">
        <div className="mx-auto max-w-5xl">
          {article.body && (
            <div className="prose prose-lg prose-blue max-w-none break-words [word-break:break-word] [overflow-wrap:anywhere] overflow-hidden sm:overflow-visible">
